...
@click.option('--report', type=click.Path(), default='reports/bulk_report.json', help='Path to output report')
...
@click.option('--format', type=click.Choice(['json', 'yaml', 'python', 'text', 'image']), help='Content format')
