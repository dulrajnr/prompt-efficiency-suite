...
def test_improvement_calculation(optimizer):
    ...
    original_metrics = {"total_tokens": 100, "total_time": 1.0}

    optimized_metrics = {"total_tokens": 80, "total_time": 0.8}

    improvement = optimizer._calculate_improvement(original_metrics, optimized_metrics)
...
def test_better_candidate_detection(optimizer, sample_config):
    ...
    original_metrics = {"total_tokens": 100, "total_time": 1.0, "success_rate": 0.8}

    better_metrics = {"total_tokens": 80, "total_time": 0.8, "success_rate": 0.9}
...
def test_optimize_prompt(optimizer):
    ...
    optimized, metrics = optimizer.optimize_prompt(prompt=prompt, model=ModelType.GPT4)
