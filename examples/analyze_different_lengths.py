#!/usr/bin/env python3
"""
Example script demonstrating analysis of prompts with different lengths.
"""
...
async def analyze_prompt(analyzer, prompt, length_type):
    """Analyze a prompt and print the results."""
    print(f"\nAnalyzing {length_type} Length Prompt:")
    print("=" * 50)
    print(f"Prompt:\n{prompt}")
...
async def main():
    ...
    # Example prompts with different lengths
    prompts = {
        "Very Short": """
    ...
    for length_type, prompt in prompts.items():
        await analyze_prompt(analyzer, prompt, length_type)
        print("\n" + "=" * 50 + "\n")
