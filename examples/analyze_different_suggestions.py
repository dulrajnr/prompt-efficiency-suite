#!/usr/bin/env python3
"""
Example script demonstrating analysis of prompts with different suggestions.
"""
...
async def analyze_prompt(analyzer, prompt, suggestion_type):
    """Analyze a prompt and print the results."""
    print(f"\nAnalyzing {suggestion_type} Suggestion Prompt:")
    print("=" * 50)
    print(f"Prompt:\n{prompt}")
...
async def main():
    ...
    # Example prompts with different suggestions
    prompts = {
        "Clarity": """
    ...
    # Analyze each prompt
    for suggestion_type, prompt in prompts.items():
        await analyze_prompt(analyzer, prompt, suggestion_type)
        print("\n" + "=" * 50 + "\n")
