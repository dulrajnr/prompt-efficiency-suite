#!/usr/bin/env python3
"""
Example script demonstrating analysis of prompts with different complexities.
"""
...
async def analyze_prompt(analyzer, prompt, complexity_type):
    """Analyze a prompt and print the results."""
    print(f"\nAnalyzing {complexity_type} Complexity Prompt:")
    print("=" * 50)
    print(f"Prompt:\n{prompt}")
...
async def main():
    ...
    # Example prompts with different complexities
    prompts = {
        "Simple": """
        ...
        There are several key points to understand.
        The problem has multiple aspects to consider.
        We need to think about various scenarios.
        The context is complex and multifaceted.
        ...
        It covers all the important aspects.
    ...
    # Analyze each prompt
    for complexity_type, prompt in prompts.items():
        await analyze_prompt(analyzer, prompt, complexity_type)
        print("\n" + "=" * 50 + "\n")
