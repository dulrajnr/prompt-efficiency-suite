#!/usr/bin/env python3
"""
Example script demonstrating analysis of prompts with different outputs.
"""
...
async def analyze_prompt(analyzer, prompt, output_type):
    """Analyze a prompt and print the results."""
    print(f"\nAnalyzing {output_type} Output Prompt:")
    print("=" * 50)
    print(f"Prompt:\n{prompt}")
...
async def main():
    ...
    # Example prompts with different outputs
    prompts = {
        "Text": """
        ...
        Output: The output should be a text response.
        """,
        ...
        Instruction: Help me with this task.
        Example: Here's an example.
        Output: The output should be a code snippet.
        """,
        ...
        Instruction: Help me with this task.
        Example: Here's an example.
        Output: The output should be a JSON object.
        """,
        ...
        Instruction: Help me with this task.
        Example: Here's an example.
        Output: The output should be a table.
        """,
        ...
        Instruction: Help me with this task.
        Example: Here's an example.
        Output: The output should be a list.
        """,
        ...
        Instruction: Help me with this task.
        Example: Here's an example.
        Output: The output should include text, code, and data.
        """
    }
    
    # Analyze each prompt
    for output_type, prompt in prompts.items():
        await analyze_prompt(analyzer, prompt, output_type)
        print("\n" + "=" * 50 + "\n")
